...
export default class VenuSeeder implements Seeder {
  public async run(dataSource: DataSource): Promise<any> {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      venu.description = venuData[i].description;
      venu.capacity = venuData[i].capacity;
      venu.facilities = venuData[i].facilities;
      venu.availableTime = venuData[i].availableTime;
      venu.imageUrl = venuData[i].imageUrl;
